...
def test_both_old_and_new_names_are_refused_as_database_passwords():
    """The product was renamed from deskflow to Deskify. "deskflow" stays on
    this list permanently: it is the published dev password in this repo's
    history, and renaming a product does not make an old password safe."""
